(function() {
  ...
  module.exports.__defineGetter__('ProtoBufClient', function() {
    return this._pbcClient || (this._pbcClient = require('./lib/protobuf_client'));
  });
  module.exports.__defineGetter__('ProtoBufPool', function() {
    return this._pbcPool || (this._pbcPool = require('./lib/protobuf'));
  });
  module.exports.__defineGetter__('HttpClient', function() {
    return this._httpClient || (this._httpClient = require('./lib/http_client'));
  });
}).call(this);
